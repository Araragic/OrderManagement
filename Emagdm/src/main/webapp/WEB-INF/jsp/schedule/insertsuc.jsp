	...
	<div class="alert alert-block alert-success">
		...
		<p>
			...
			<button class="btn btn-sm btn-success"
				onclick="window.location.href='../index/home#ajax/schedule/insert?id=<%=schedule.getRequirement_id()%>'">继续添加</button>
			<a
				href="../index/home#ajax/schedule/modifi?schedule_num=<%=schedule.getSchedule_num()%>"><button
