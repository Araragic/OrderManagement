...
<body style="background-color: white">
	<div class="alert alert-block alert-success">
		...
		<p>
			<strong> <i class="ace-icon fa fa-check"></i> 添加成功!
			</strong> 您已经成功添加需求工单。
		</p>

		<p>
			<button class="btn btn-sm btn-success"
				onclick="window.location.href='../index/home#ajax/requirement/insert'">继续添加</button>
			<%
				Requirement requirement = (Requirement) request
						.getAttribute("requirement");
			%>
			<a
				href="../index/home#ajax/requirement/modifi?requirement_num=<%=requirement.getRequirement_num()%>"><button
					class="btn btn-sm">查看详情</button></a>
		</p>
	</div>
</body>
